// Final polish: visually centered layout, balanced for desktop and mobile
...
export default function Dashboard({ user }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-slate-100 dark:from-slate-900 dark:to-slate-800 text-slate-800 dark:text-slate-100 flex justify-center px-4 sm:px-8 lg:px-20 xl:px-40 py-10">
      <div className="w-full max-w-4xl">
        <div className="bg-white dark:bg-slate-800 shadow-xl rounded-xl p-8">
          <h2 className="text-2xl font-bold text-center mt-2 mb-6">Your To-Do Lists 📝</h2>

          <form onSubmit={addList} className="flex gap-2 mb-8 flex-col sm:flex-row">
            <input
              type="text"
