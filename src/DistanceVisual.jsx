export default function DistanceVisual({ name1, name2, loc1, loc2, km, mi }) {
  return (
    <div className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-800 dark:to-slate-900 text-center">
